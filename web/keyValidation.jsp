...
<html>
    <head>
        ...
        <title> التحقق من صحة الرمز</title>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="panel-body">
                                                <form class="form" action="KeyValidationServlet" method="post">
                                                    <fieldset>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="glyphicon glyphicon-off color-blue"></i></span>

                                                                <input id="key" name="vkey" placeholder="ادخل الرمز " class="form-control" type="text" required></div>
                                                        </div>
                                                        <div class="form-group">
                                                            <input class="btn btn-lg btn-primary btn-block" value="إرسال الرمز" type="submit">
                                                        </div>
                                                    </fieldset>
                                                </form>
