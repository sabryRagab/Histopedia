 ...
 * @author OSAMA
 */
@WebServlet(name = "DisplayAccountServlet", urlPatterns = {"/DisplayAccountServlet"})
public class DisplayAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher View = getServletContext().getRequestDispatcher("/updateAccount.jsp");
