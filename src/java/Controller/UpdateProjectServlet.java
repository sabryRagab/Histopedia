 ...
 * @author sabry
 */
@WebServlet(name = "UpdateProjectServlet", urlPatterns = {"/UpdateProjectServlet"})
public class UpdateProjectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int is_published = (request.getParameter("is_published") == null ? 0 : 1);
            Project p = new Project();
            p.setProject_id(project_id);
            p.setProject_desc(project_desc);
            p.setIs_published(is_published);
