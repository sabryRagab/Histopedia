 ...
 * @author AbdElRahman
 */
@WebServlet(name = "setEvent", urlPatterns = {"/setEvent"})
public class setEvent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            event.setEventDate(year, mon, day, Integer.parseInt(project_id));
            int id = event.getLastEventId();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(setEvent.class.getName()).log(Level.SEVERE, null, ex);
